...
namespace Command
{
    public class Product
    {
        ...
        {
            this.Price += amount;
            Console.WriteLine($"This price for the {this.Name} has been increased by {amount}$.");
        }
        ...
        public void DecreasePrice(decimal amount)
        {
            ...
            Console.WriteLine($"This price for the {this.Name} has been decreased by {amount}$.");
        }
