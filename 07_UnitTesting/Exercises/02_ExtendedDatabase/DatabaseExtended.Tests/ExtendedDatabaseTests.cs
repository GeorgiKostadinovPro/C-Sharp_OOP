...
namespace DatabaseExtended.Tests
{
    ...
    public class ExtendedDatabaseTests
    {
        ...
        public void Init()
        {
            ...
            this.twoPeopleInDatabase = new Database(twoPeopleList);
            ...
            this.fullDatabase = new Database(sixteenPeopleList);
        }
        ...
        {
            Person newPerson = new Person(1235, "George");
        ...
        {
            Assert.That(() => twoPeopleInDatabase.Add(new Person(3, "George0")), Throws.InvalidOperationException.With.Message
        ...
        {
            Person newPerson = new Person(12, "Lyubo");
        ...
        {
            Assert.That(() => fullDatabase.FindByUsername("Kris"),
        ...
        {
            Assert.That(() => fullDatabase.FindByUsername("Lyubo"), Throws.InvalidOperationException.With.Message.EqualTo("No user is present by this username!"));
        }

        [Test]
        public void FindByUsernameShouldReturnPersonWithThatUsername()
        {
            Person result = fullDatabase.FindByUsername("George0");
            Person expected = new Person(1234, "George0");
        ...
        public void FindByIdShouldReturnPersonWithThatId()
        {
            ...
            Person expected = new Person(1235, "George1");
