namespace Chainblock.Tests
{
    ...
    public class ChainblockTests
    {
        ...
        public void SetUp()
        {
            this.defTransaction = new Transaction(1, TransactionStatus.Successfull, "Pesho", "Gosho", 50);
        ...
        public void AddingTransactionShouldPhysicallyAddTheTransaction()
        {
            ITransaction transactionToAdd =
                new Transaction(1, TransactionStatus.Successfull, "Pesho", "Gosho", 50);
        ...
        public void ChangeTransactionStatusShouldChangeTheStatusValueWhenSuccess()
        {
            ...
            this.chainblock.ChangeTransactionStatus(transaction.Id, TransactionStatus.Successfull);
        ...
        {
            ITransaction secondTransaction =
                new Transaction(2, TransactionStatus.Successfull, "sss", "rrr", 30);
            ...
            IEnumerable<ITransaction> actual = this.chainblock.GetByTransactionStatus(TransactionStatus.Successfull);
        ...
        public void GetAllSendersByStatusShouldReturnCorrectSendersOrderedWithNoDuplication()
        {
            ...
            IEnumerable<string> actual = this.chainblock.GetAllSendersWithTransactionStatus(TransactionStatus.Successfull);
        ...
        public void GetAllSendersByStatusShouldReturnCorrectSendersOrderedWithDuplications()
        {
            ...
            ITransaction fourthTransaction =
                new Transaction(4, TransactionStatus.Successfull, secondTransaction.From, "aaa", 25);
        ...
        public void GetAllReceiversByStatusShouldReturnCorrectSendersOrderedWithNoDuplication()
        {
            ...
            IEnumerable<string> actual = this.chainblock.GetAllReceiversWithTransactionStatus(TransactionStatus.Successfull);
        ...
        public void GetAllReceiversByStatusShouldReturnCorrectSendersOrderedWithDuplications()
        {
            ...
            ITransaction thirdTransaction =
                new Transaction(3, TransactionStatus.Aborted, "aaa", "aaa", 15);
            ITransaction fourthTransaction =
                new Transaction(4, TransactionStatus.Successfull, "vancho", secondTransaction.To, 25);
        ...
        {
            ITransaction secondTransaction =
                new Transaction(2, TransactionStatus.Successfull, "aaa", "bbb", 40);
            ITransaction thirdTransaction =
                new Transaction(3, TransactionStatus.Successfull, "ccc", "ddd", 40);
        ...
        public void ChainblockShouldBeIterable()
        {
            ...
            ITransaction thirdTransaction =
                new Transaction(3, TransactionStatus.Aborted, "aaa", "aaa", 15);
            ITransaction fourthTransaction =
                new Transaction(4, TransactionStatus.Successfull, "Mimi", "aaa", 25);
